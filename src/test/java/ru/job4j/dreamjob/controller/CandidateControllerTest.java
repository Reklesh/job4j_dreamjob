...
public class CandidateControllerTest {
    ...
    public void whenRequestNonExistentCandidateByIdThenGetErrorPage() {
        ...
        assertThat(view).isEqualTo("errors/404");
        assertThat(actualMessage).isEqualTo("Резюме кандидата с указанным идентификатором не найдено");
    }
    ...
    @Test
    public void whenUpdateCandidateThrowsExceptionThenGetErrorPage() {
        var expectedException = new RuntimeException("Failed to write file");
